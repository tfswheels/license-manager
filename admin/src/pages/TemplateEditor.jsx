    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-6 bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:divide-x divide-gray-200">
          ...
          <div className="p-4 lg:p-6">
            ...
            {activeTab === 'html' ? (
              <textarea
                ...
                className="w-full h-[400px] lg:h-[600px] font-mono text-sm p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
          ...
          {/* Right: Live Preview */}
          <div className="p-4 lg:p-6 bg-gray-50 border-t lg:border-t-0">
            ...
            {activeTab === 'html' ? (
              ...
              <pre className="bg-white p-4 rounded-lg border border-gray-200 h-[400px] lg:h-[600px] overflow-auto text-sm whitespace-pre-wrap">
