...
router.post('/support/send', async (req, res) => {
  try {
    ...
    const sendgridApiKey = process.env.SENDGRID_API_KEY || process.env.MAIL_API_KEY;
    ...
    const emailContent = {
      to: process.env.ADMIN_EMAIL || 'mail@digikeyhq.com',
      from: process.env.FROM_EMAIL || 'mail@digikeyhq.com',
      replyTo: email,
